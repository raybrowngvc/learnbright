...
<head>
    <title>Digital Photography - Learn Brights</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row mb-8">
                <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                    ...
                    <p class="me-xl-13 mb-5">This course provides an introduction to digital photography, focusing on the technical skills and artistic concepts needed to create compelling images. Students will learn about camera operation, exposure settings, composition techniques, lighting, and post-processing. Through hands-on practice and critiques, students will develop their photographic skills and personal style.</p>
                ...
                <!-- COURSE INFO TAB
                    ...
                    <div id="Overview" class="mb-8">
                        ...
                        <p>This course provides an introduction to digital photography, focusing on the technical skills and artistic concepts needed to create compelling images. Students will learn about camera operation, exposure settings, composition techniques, lighting, and post-processing. Through hands-on practice and critiques, students will develop their photographic skills and personal style.</p><h4>Learning Objectives:</h4><p>By the end of this course, students should be able to:</p><ol><li>Understand the basic functions and settings of a digital camera.</li><li>Apply principles of exposure, composition, and lighting to create well-crafted photographs.</li><li>Use post-processing software to enhance and edit images.</li><li>Critically analyze photographs and provide constructive feedback.</li><li>Develop a personal style and photographic portfolio.</li></ol><hr><h3>Week 1: Introduction to Digital Photography</h3><ul><li>Course Overview and Objectives</li><li>Brief History of Photography</li><li>Types of Digital Cameras: DSLRs, Mirrorless, Point-and-Shoot</li><li>Basic Camera Components and Functions</li><li>Exercise: Exploring Your Camera</li></ul><h3>Week 2: Understanding Exposure</h3><ul><li>The Exposure Triangle: Aperture, Shutter Speed, ISO</li><li>Manual vs. Automatic Modes</li><li>Exposure Compensation and Metering Modes</li><li>Exercise: Controlling Exposure in Different Lighting Conditions</li></ul><h3>Week 3: Composition Techniques</h3><ul><li>Rule of Thirds and Leading Lines</li><li>Framing and Perspective</li><li>Symmetry, Patterns, and Textures</li><li>Depth of Field and Background Control</li><li>Exercise: Composing Effective Photographs</li></ul><h3>Week 4: Lighting in Photography</h3><ul><li>Natural vs. Artificial Light</li><li>Understanding Light Quality and Direction</li><li>Using Reflectors and Diffusers</li><li>Basic Studio Lighting Setup</li><li>Exercise: Experimenting with Different Lighting Scenarios</li></ul><h3>Week 5: Focus and Depth of Field</h3><ul><li>Autofocus vs. Manual Focus</li><li>Focus Points and Focus Modes</li><li>Controlling Depth of Field</li><li>Bokeh and Background Blur Techniques</li><li>Exercise: Practicing Focus and Depth of Field</li></ul><h3>Week 6: Color Theory and White Balance</h3><ul><li>Understanding Color Theory in Photography</li><li>White Balance Settings and Color Temperature</li><li>Using Filters for Color Correction</li><li>Exercise: Adjusting White Balance and Using Color Creatively</li></ul><h3>Week 7: Motion and Time in Photography</h3><ul><li>Capturing Motion: Freezing vs. Blurring</li><li>Long Exposure Techniques</li><li>Panning and Motion Blur Effects</li><li>Exercise: Creating Dynamic Motion Photographs</li></ul><h3>Week 8: Portrait Photography</h3><ul><li>Basics of Portraiture</li><li>Posing and Directing Subjects</li><li>Using Natural and Artificial Light in Portraits</li><li>Exercise: Taking Portraits with Different Lighting Setups</li></ul><h3>Week 9: Landscape and Nature Photography</h3><ul><li>Composing Landscape Shots</li><li>Using Wide-Angle Lenses</li><li>Working with Natural Light and Weather Conditions</li><li>Exercise: Capturing Scenic Landscapes</li></ul><h3>Week 10: Street and Documentary Photography</h3><ul><li>Principles of Street Photography</li><li>Candid vs. Posed Shots</li><li>Ethics and Legal Considerations</li><li>Exercise: Documenting Everyday Life through Photography</li></ul><h3>Week 11: Post-Processing and Editing</h3><ul><li>Introduction to Post-Processing Software (Adobe Lightroom, Photoshop)</li><li>Basic Editing Techniques: Cropping, Adjusting Exposure, Color Correction</li><li>Advanced Editing: Retouching, Filters, Special Effects</li><li>Exercise: Enhancing Images with Post-Processing Tools</li></ul><h3>Week 12: Developing a Personal Style</h3><ul><li>Identifying and Developing a Personal Style</li><li>Inspiration and Influences in Photography</li><li>Creating a Cohesive Body of Work</li><li>Exercise: Curating a Themed Photo Series</li></ul><h3>Week 13: Critique and Feedback</h3><ul><li>Importance of Critique in Photography</li><li>Giving and Receiving Constructive Feedback</li><li>Group Critique Session: Reviewing Student Work</li><li>Exercise: Participating in Peer Critiques</li></ul><h3>Week 14: Building a Photography Portfolio</h3><ul><li>Selecting and Organizing Images for a Portfolio</li><li>Portfolio Presentation Techniques</li><li>Creating an Online Portfolio or Photo Book</li><li>Exercise: Assembling Your Photography Portfolio</li></ul><h3>Week 15: Final Exhibition and Course Wrap-Up</h3><ul><li>Preparing for a Photography Exhibition</li><li>Presenting Work to an Audience</li><li>Course Summary and Key Takeaways</li><li>Final Exhibition: Displaying Student Work</li><li>Feedback and Future Learning Paths</li></ul><hr><h4>Course Materials:</h4><ul><li>Textbook: "Understanding Exposure" by Bryan Peterson</li><li>Online Resources: Photography Blogs, Tutorials, and Forums</li><li>Software: Adobe Lightroom, Photoshop, or equivalent post-processing tools</li><li>Equipment: DSLR or Mirrorless Camera, Tripod, Reflectors, External Flash (optional)</li></ul><h4>Assessment Methods:</h4><ul><li>Participation and Attendance: 10%</li><li>Weekly Assignments and Exercises: 40%</li><li>Mid-Term Project: 20%</li><li>Final Portfolio and Exhibition: 20%</li><li>Peer Critiques and Feedback: 10%</li></ul><hr>
                    ...
                    <div class="d-block rounded border p-2 shadow mb-6">
                        ...
                        <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                            <div class="d-flex align-items-center mb-2">
                                <ins class="h2 mb-0">€550.99</ins>
                                <del class="ms-3">860</del>
                            ...
                            <div class="d-flex align-items-center text-alizarin mb-6">
                                ...
                                <span class="ms-2">3 days left at this price!</span>
                            </div>

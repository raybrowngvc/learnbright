...
<head>
    <title>Arts And Creative Skills - Learn Brights</title>
...
<body class="bg-white">
    ...
    <header class="py-8 py-md-12 overlay overlay-primary overlay-80" style="background-image: url(assets/img/covers/cover-19.jpg);">
        <div class="container text-center py-xl-5">
            <h1 class="display-4 fw-semi-bold mb-0 text-white">Arts And Creative Skills</h1>
    ...
    <!-- COURSE
    ================================================== -->
    <div class="container pb-4 pb-xl-7" style="margin-top:80px;">
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card card-border-hover border shadow-dark-hover p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        ...
                        <a href="digital-photography.php" class="card-img sk-thumbnail d-block">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <!-- Preheading -->
                        <a href="arts-and-creative-skills.php"><span class="mb-1 d-inline-block text-gray-800">Arts And Creative Skills</span></a>

                        <!-- Heading -->
                        <div class="position-relative">
                            <a href="digital-photography.php" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Digital Photography</h4></a>
                            ...
                            <div class="row mx-n2 align-items-end">
                                    ...
                                    <ul class="nav mx-n3">
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">3 lessons</div>
                                            </div>
                                        </li>
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">10h 12m</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-auto px-2 text-right">
                                    <del class="font-size-sm">€860</del>
                                    <ins class="h4 mb-0 d-block mb-lg-n1">€550.99</ins>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card card-border-hover border shadow-dark-hover p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        ...
                        <a href="graphic-design-essentials.php" class="card-img sk-thumbnail d-block">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <!-- Heading -->
                        <div class="position-relative">
                            <a href="graphic-design-essentials.php" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Graphic Design Essentials</h4></a>
                            ...
                            <div class="row mx-n2 align-items-end">
                                    ...
                                    <ul class="nav mx-n3">
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">6 lessons</div>
                                            </div>
                                        </li>
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">15h 30m</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-auto px-2 text-right">
                                    <del class="font-size-sm">€800</del>
                                    <ins class="h4 mb-0 d-block mb-lg-n1">€490</ins>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card card-border-hover border shadow-dark-hover p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        ...
                        <a href="creative-writing-and-storytelling.php" class="card-img sk-thumbnail d-block">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <!-- Heading -->
                        <div class="position-relative">
                            <a href="creative-writing-and-storytelling.php" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Creative Writing and Storytelling</h4></a>
                            ...
                            <div class="row mx-n2 align-items-end">
                                    ...
                                    <ul class="nav mx-n3">
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">3.5 lessons</div>
                                            </div>
                                        </li>
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">6h 45m</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-auto px-2 text-right">
                                    <del class="font-size-sm">€850</del>
                                    <ins class="h4 mb-0 d-block mb-lg-n1">€425</ins>
                                </div>
                            </div>
                        </div>
                    </div>

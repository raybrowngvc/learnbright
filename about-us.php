...
<head>
    <title>About Us - Learn Brights</title>
...
<body class="bg-white">
    ...
    <!-- ABOUT V1
    ================================================== -->
    <div class="container pb-4 pb-xl-7 mt-5">
        <div class="text-center mb-md-6 mb-4">
            <h1 class="mb-3">Our Mission</h1>
            <p class="font-size-lg mb-5 text-capitalize">At Learn Bright, our mission is to empower individuals with the skills and learning needed to succeed in today's dynamic professional landscape. Through our accessible, high-quality courses, we strive to inspire lifelong learning and career advancement for both beginners and professionals. We are committed to foster a supportive learning environment that encourages innovation, creativity, and personal growth, ultimately enabling our learners to achieve their optimum potential in their chosen fields.</p>

        </div>        
        <div class="text-center mb-md-6 mb-4">
            <h1 class="mb-3">Who We Are</h1>
            <p class="font-size-lg mb-5 text-capitalize">Learn bright is a Leading Online Learning Platform offering a vast array of courses across various fields and disciplines. We are a dedicated team of educators, industry experts, and professionals passionate for helping individuals to thrive in their careers. With years of experience, we create and deliver comprehensive skill-building courses tailored to equip learners with the instruments and knowledge required to excel in today's competitive job market.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <h4 class="mb-1">Expert-Led Courses</h4>
                    <p class="px-lg-7 px-xl-8">Learn from experienced industry experts having years of experience in their fields, providing you with the updated and relevant knowledge and skills.</p>
                </div>
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <p class="px-lg-7 px-xl-8">Study at your own pace, whenever and wherever you want, with our flexible learning platform that adapts to your schedule and learning style.</p>
                </div>
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <h4 class="mb-1">Interactive and Engaging</h4>
                    <p class="px-lg-7 px-xl-8">Engage with Learn Bright’s interactive course materials, videos, quizzes, and discussions, to stay motivated and retain information better, ensuring you’re completely prepared for challenges in your career.</p>
                </div>
            </div>
        </div>
    </section>

...
<head>
    <title>Graphic Design Essentials - Learn Brights</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row mb-8">
                <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                    ...
                    <p class="me-xl-13 mb-5">This course provides an introduction to the essential concepts and techniques of graphic design. Students will learn about design principles, typography, color theory, and the use of industry-standard software. Through practical exercises and projects, students will develop their skills and create compelling visual designs.</p>
                ...
                <!-- COURSE INFO TAB
                    ...
                    <div id="Overview" class="mb-8">
                        ...
                        <p>This course provides an introduction to the essential concepts and techniques of graphic design. Students will learn about design principles, typography, color theory, and the use of industry-standard software. Through practical exercises and projects, students will develop their skills and create compelling visual designs.</p><h4>Learning Objectives:</h4><p>By the end of this course, students should be able to:</p><ol><li>Understand and apply basic design principles.</li><li>Use graphic design software to create and manipulate visual elements.</li><li>Apply typography and color theory effectively in design projects.</li><li>Develop and present design concepts from initial idea to final product.</li><li>Critically analyze and provide constructive feedback on design work.</li></ol><hr><h3>Week 1: Introduction to Graphic Design</h3><ul><li>Course Overview and Objectives</li><li>Brief History of Graphic Design</li><li>Roles and Responsibilities of a Graphic Designer</li><li>Overview of Design Tools and Software</li><li>Exercise: Exploring Graphic Design Tools</li></ul><h3>Week 2: Design Principles and Elements</h3><ul><li>Basic Design Principles: Balance, Contrast, Emphasis, Movement, Proportion, Rhythm, Unity</li><li>Design Elements: Line, Shape, Space, Texture, Form, Value</li><li>Creating Effective Compositions</li><li>Exercise: Applying Design Principles in Simple Projects</li></ul><h3>Week 3: Introduction to Adobe Photoshop</h3><ul><li>Overview of Adobe Photoshop Interface and Tools</li><li>Basic Image Editing Techniques</li><li>Layers and Masks</li><li>Exercise: Creating a Simple Composite Image</li></ul><h3>Week 4: Introduction to Adobe Illustrator</h3><ul><li>Overview of Adobe Illustrator Interface and Tools</li><li>Working with Vector Graphics</li><li>Creating and Editing Shapes and Paths</li><li>Exercise: Designing a Vector Illustration</li></ul><h3>Week 5: Introduction to Adobe InDesign</h3><ul><li>Overview of Adobe InDesign Interface and Tools</li><li>Creating and Managing Documents</li><li>Working with Text and Images</li><li>Exercise: Designing a Simple Print Layout</li></ul><h3>Week 6: Typography Basics</h3><ul><li>Understanding Typography: Typefaces, Fonts, and Families</li><li>Principles of Good Typography</li><li>Text Alignment, Spacing, and Hierarchy</li><li>Exercise: Designing a Typographic Poster</li></ul><h3>Week 7: Color Theory and Application</h3><ul><li>Basics of Color Theory: Color Wheel, Harmonies, and Schemes</li><li>Color Psychology and Its Impact on Design</li><li>Using Color Effectively in Digital and Print Media</li><li>Exercise: Creating a Color Palette and Applying It to a Design</li></ul><h3>Week 8: Branding and Logo Design</h3><ul><li>Introduction to Branding: Concepts and Importance</li><li>Principles of Logo Design</li><li>Developing a Brand Identity</li><li>Exercise: Designing a Logo and Brand Elements</li></ul><h3>Week 9: Layout and Composition</h3><ul><li>Principles of Layout Design: Grids, Alignment, and White Space</li><li>Designing for Different Formats: Print, Web, Mobile</li><li>Creating Visual Hierarchies and Flow</li><li>Exercise: Designing a Multi-Page Layout</li></ul><h3>Week 10: User Interface (UI) Design Basics</h3><ul><li>Introduction to UI Design: Concepts and Best Practices</li><li>Designing User Interfaces for Websites and Apps</li><li>Wireframing and Prototyping Tools</li><li>Exercise: Creating a Wireframe for a Simple Web Page</li></ul><h3>Week 11: Digital Illustration Techniques</h3><ul><li>Advanced Vector Techniques in Adobe Illustrator</li><li>Creating Illustrations for Different Purposes: Editorial, Commercial, Infographic</li><li>Exercise: Designing a Complex Vector Illustration</li></ul><h3>Week 12: Motion Graphics Introduction</h3><ul><li>Basics of Motion Graphics and Animation</li><li>Introduction to Adobe After Effects</li><li>Creating Simple Animations and Transitions</li><li>Exercise: Designing a Short Motion Graphic</li></ul><h3>Week 13: Project Development and Critique</h3><ul><li>Planning and Developing a Design Project</li><li>Iterative Design Process: Feedback and Revisions</li><li>Group Critique Sessions: Reviewing and Refining Projects</li><li>Exercise: Developing a Capstone Project</li></ul><h3>Week 14: Portfolio Development</h3><ul><li>Importance of a Professional Portfolio</li><li>Selecting and Organizing Work for a Portfolio</li><li>Creating an Online Portfolio or PDF</li><li>Exercise: Assembling Your Design Portfolio</li></ul><h3>Week 15: Final Presentation and Course Wrap-Up</h3><ul><li>Preparing and Presenting Design Work</li><li>Course Summary and Key Takeaways</li><li>Final Project Presentation</li><li>Feedback and Future Learning Paths</li></ul><hr><h4>Course Materials:</h4><ul><li>Textbook: "Graphic Design School: A Foundation Course for Graphic Designers Working in Print, Moving Image and Digital Media" by David Dabner, Sandra Stewart, and Eric Zempol</li><li>Online Resources: Adobe Tutorials, Graphic Design Blogs, and Forums</li><li>Software: Adobe Creative Cloud (Photoshop, Illustrator, InDesign, After Effects)</li></ul><h4>Assessment Methods:</h4><ul><li>Participation and Attendance: 10%</li><li>Weekly Assignments and Exercises: 40%</li><li>Mid-Term Project: 20%</li><li>Final Portfolio and Presentation: 20%</li><li>Peer Critiques and Feedback: 10%</li></ul><hr>
                    ...
                    <div class="d-block rounded border p-2 shadow mb-6">
                        ...
                        <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                            <div class="d-flex align-items-center mb-2">
                                <ins class="h2 mb-0">€490</ins>
                                <del class="ms-3">800</del>
                            ...
                            <div class="d-flex align-items-center text-alizarin mb-6">
                                ...
                                <span class="ms-2">6 days left at this price!</span>
                            </div>

...
<head>
    <title>Technology And Programming - Learn Brights</title>
...
<body class="bg-white">
    ...
    <header class="py-8 py-md-12 overlay overlay-primary overlay-80" style="background-image: url(assets/img/covers/cover-19.jpg);">
        <div class="container text-center py-xl-5">
            <h1 class="display-4 fw-semi-bold mb-0 text-white">Technology And Programming</h1>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card card-border-hover border shadow-dark-hover p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        ...
                        <a href="python-for-beginners.php" class="card-img sk-thumbnail d-block">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <!-- Preheading -->
                        <a href="technology-and-programming.php"><span class="mb-1 d-inline-block text-gray-800">Technology And Programming</span></a>

                        <!-- Heading -->
                        <div class="position-relative">
                            <a href="python-for-beginners.php" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Python for Beginners</h4></a>
                            ...
                            <div class="row mx-n2 align-items-end">
                                    ...
                                    <ul class="nav mx-n3">
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">All lessons</div>
                                            </div>
                                        </li>
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">2 Days</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-auto px-2 text-right">
                                    <del class="font-size-sm">€980</del>
                                    <ins class="h4 mb-0 d-block mb-lg-n1">€700</ins>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card card-border-hover border shadow-dark-hover p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        ...
                        <a href="full-stack-web-development.php" class="card-img sk-thumbnail d-block">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <!-- Heading -->
                        <div class="position-relative">
                            <a href="full-stack-web-development.php" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Full-Stack Web Development</h4></a>
                            ...
                            <div class="row mx-n2 align-items-end">
                                    ...
                                    <ul class="nav mx-n3">
                                        ...
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">12h 10m</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-auto px-2 text-right">
                                    <del class="font-size-sm">€960</del>
                                    <ins class="h4 mb-0 d-block mb-lg-n1">€560</ins>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card card-border-hover border shadow-dark-hover p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        ...
                        <a href="cybersecurity-fundamentals.php" class="card-img sk-thumbnail d-block">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <!-- Heading -->
                        <div class="position-relative">
                            <a href="cybersecurity-fundamentals.php" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Cybersecurity Fundamentals</h4></a>
                            ...
                            <div class="row mx-n2 align-items-end">
                                    ...
                                    <ul class="nav mx-n3">
                                        ...
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">9h 40m</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-auto px-2 text-right">
                                    <del class="font-size-sm">€750</del>
                                    <ins class="h4 mb-0 d-block mb-lg-n1">€450</ins>
                                </div>
                            </div>
                        </div>
                    </div>

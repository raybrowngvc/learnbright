...
<head>
    <title>Full-Stack Web Development - Learn Brights</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row mb-8">
                <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                    ...
                    <p class="me-xl-13 mb-5">This course provides a comprehensive introduction to full-stack web development. Students will learn to build dynamic, responsive, and interactive web applications using modern technologies. The course covers both front-end and back-end development, including HTML, CSS, JavaScript, frameworks, databases, server-side languages, and deployment.</p>
                ...
                <!-- COURSE INFO TAB
                    ...
                    <div id="Overview" class="mb-8">
                        ...
                        <p>This course provides a comprehensive introduction to full-stack web development. Students will learn to build dynamic, responsive, and interactive web applications using modern technologies. The course covers both front-end and back-end development, including HTML, CSS, JavaScript, frameworks, databases, server-side languages, and deployment.</p><h4>Learning Objectives:</h4><p>By the end of this course, students should be able to:</p><ol><li>Understand and use HTML, CSS, and JavaScript to create responsive web pages.</li><li>Utilize front-end frameworks and libraries such as React or Angular.</li><li>Develop back-end applications using server-side languages like Node.js or Python.</li><li>Design and manage databases using SQL and NoSQL databases.</li><li>Implement RESTful APIs to connect front-end and back-end.</li><li>Deploy web applications to the cloud.</li><li>Apply version control using Git and GitHub.</li></ol><hr><h3>Week 1: Introduction to Web Development</h3><ul><li>Overview of Full-Stack Web Development</li><li>Setting Up the Development Environment (VS Code, Node.js, Git)</li><li>Introduction to HTML: Basic Structure, Elements, and Attributes</li><li>Exercise: Creating a Simple HTML Page</li></ul><h3>Week 2: Styling with CSS</h3><ul><li>Introduction to CSS: Syntax and Selectors</li><li>Box Model, Flexbox, and Grid Layouts</li><li>Responsive Design and Media Queries</li><li>Exercise: Designing a Responsive Web Page</li></ul><h3>Week 3: JavaScript Fundamentals</h3><ul><li>Introduction to JavaScript: Syntax and Data Types</li><li>Functions, Loops, and Conditionals</li><li>DOM Manipulation</li><li>Event Handling</li><li>Exercise: Creating Interactive Web Pages with JavaScript</li></ul><h3>Week 4: Advanced JavaScript and ES6+</h3><ul><li>ES6 Features: Arrow Functions, Let/Const, Template Literals</li><li>Asynchronous JavaScript: Promises, Async/Await</li><li>Modules and Imports</li><li>Exercise: Building Advanced JavaScript Applications</li></ul><h3>Week 5: Front-End Frameworks – React</h3><ul><li>Introduction to React: Components and JSX</li><li>State and Props</li><li>Lifecycle Methods and Hooks</li><li>React Router for Single Page Applications (SPAs)</li><li>Exercise: Building a React Application</li></ul><h3>Week 6: Back-End Development with Node.js</h3><ul><li>Introduction to Node.js and Express.js</li><li>Setting Up a Server</li><li>Handling Requests and Responses</li><li>Middleware and Routing</li><li>Exercise: Building a Simple Server with Node.js</li></ul><h3>Week 7: Working with Databases – SQL and NoSQL</h3><ul><li>Introduction to Databases: SQL vs. NoSQL</li><li>Setting Up and Using MySQL/PostgreSQL</li><li>Working with MongoDB</li><li>CRUD Operations</li><li>Exercise: Designing and Querying Databases</li></ul><h3>Week 8: RESTful APIs</h3><ul><li>Understanding RESTful Architecture</li><li>Creating RESTful APIs with Express.js</li><li>Connecting Front-End and Back-End</li><li>Handling HTTP Methods and Status Codes</li><li>Exercise: Building and Consuming RESTful APIs</li></ul><h3>Week 9: Authentication and Security</h3><ul><li>Introduction to Authentication and Authorization</li><li>Implementing User Authentication (JWT, OAuth)</li><li>Securing APIs and Data</li><li>Data Validation and Sanitization</li><li>Exercise: Adding Authentication to a Web Application</li></ul><h3>Week 10: Advanced Front-End Topics</h3><ul><li>State Management with Redux or Context API</li><li>Advanced React Hooks and Patterns</li><li>Performance Optimization Techniques</li><li>Exercise: Enhancing Front-End Applications</li></ul><h3>Week 11: Advanced Back-End Topics</h3><ul><li>Advanced Express.js Features</li><li>Real-Time Communication with WebSockets</li><li>Microservices Architecture</li><li>Exercise: Implementing Advanced Back-End Features</li></ul><h3>Week 12: Testing and Debugging</h3><ul><li>Unit Testing with Jest or Mocha</li><li>End-to-End Testing with Cypress or Selenium</li><li>Debugging Techniques and Tools</li><li>Exercise: Writing Tests for Web Applications</li></ul><h3>Week 13: DevOps and Deployment</h3><ul><li>Introduction to DevOps and CI/CD</li><li>Containerization with Docker</li><li>Deploying Applications to AWS, Heroku, or Vercel</li><li>Exercise: Deploying a Full-Stack Application</li></ul><h3>Week 14: Project Development</h3><ul><li>Planning and Designing a Full-Stack Project</li><li>Implementing Features and Functionality</li><li>Testing and Debugging the Project</li><li>Exercise: Developing a Capstone Project</li></ul><h3>Week 15: Final Examination and Course Wrap-Up</h3><ul><li>Final Exam</li><li>Project Presentations</li><li>Course Summary and Key Takeaways</li><li>Feedback and Future Learning Paths</li></ul><hr><h4>Course Materials:</h4><ul><li>Textbook: "Full-Stack Web Development with React and Node" by David Griffiths and Dawn Griffiths</li><li>Online Resources: MDN Web Docs, W3Schools, freeCodeCamp</li><li>Tools: VS Code, Git, Node.js, MongoDB, MySQL/PostgreSQL</li></ul><h4>Assessment Methods:</h4><ul><li>Participation and Attendance: 10%</li><li>Weekly Assignments and Exercises: 40%</li><li>Mid-Term Exam: 20%</li><li>Capstone Project and Presentation: 20%</li><li>Final Exam: 10%</li></ul><hr>
                    ...
                    <div class="d-block rounded border p-2 shadow mb-6">
                        ...
                        <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                            <div class="d-flex align-items-center mb-2">
                                <ins class="h2 mb-0">€560</ins>
                                <del class="ms-3">960</del>

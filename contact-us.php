...
<head>
    <title>Contact Us - Learn Brights</title>
...
<body class="bg-white">
    ...
    <header class="py-8 py-md-11" style="background-image: none;">
        <div class="container text-center py-xl-2">
            <h1 class="display-4 fw-semi-bold mb-0">Contact Us</h1>
			...
			<h3>Have questions or want to join, contact us through email, phone, or visit us through given details. Start now and boost your career with Learn Bright!</h3>
        </div>
        <!-- Img -->
    ...
    <div class="container">
                    ...
                    <div class="col-xl mb-6">
                        <div class="media d-flex">
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <a href="tel:+4902563139158" class="text-gray-800 d-block">+49 025 6313 9158</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl mb-6">
                        <div class="media d-flex">
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <p class="mb-0">Sat: 8 AM - 1 PM</p>
                                <p class="mb-0">Sun: Off</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl mb-6">
                        <div class="media d-flex">
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <a href="mailto:info@learnbrights.com" class="text-gray-800">info@learnbrights.com</a>
                                <a href="mailto:courses@learnbrights.com" class="text-gray-800">courses@learnbrights.com</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md">
                ...
                <form class="form-contact contact_form" action="mail.php" method="post" >
                            ...
                            <div class="form-group m-0 col-12">
                                <button class="btn btn-primary btn-block mw-md-300p" id="js-contact-btn" name="submit" type="submit">Send message</button> 
        ...
        <div class="mb-8 mb-md-11 rounded overflow-hidden grayscal-hover">
            <iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Los-Angeles-Platz%2017,%20Schleswig-Holstein,%20Germany+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
        </div>
    </div>
